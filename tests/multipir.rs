...
fn mpir_sizes() {
    ...
    for k in &BATCH {
        ...
        let schedule: HashMap<usize, Vec<usize>> = (&code as &dyn BatchCode<usize, Element>)
            .get_schedule(&keys)
            .unwrap();
        ...
        println!(
            "cuckoo query: num {}, k {}, size {}, size/k {}",
            NUM,
            *k,
            query_size / 1024,
            query_size / (*k * 1024)
        ...
        println!(
            "cuckoo reply num {}, k {}, size {}, size/k {}",
            NUM,
            *k,
            reply_size / 1024,
            reply_size / (*k * 1024)
